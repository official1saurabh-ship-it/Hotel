        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <h1 className="hero-h1">
              India's #1 <span className="fire-text">Hotel Management</span> Software
            </h1>
      ...
      <section className="section-wrap" id="modules">
        <div className="container">
          <div className="section-title-block center reveal">
            ...
            <h2 className="display-lg">Every Module Your Hotel Needs</h2>
      ...
      <section className="section-wrap alt" id="features">
        <div className="container">
          <div className="section-title-block center reveal">
            ...
            <h2 className="display-lg">Powerful Tools for Every Hotel Format</h2>
          ...
          <div className="feat-grid">
            <div className="feat-card reveal">
              <div className="feat-card-header">
                ...
                <div>
                  <div className="feat-heading">Front Desk & Room Booking</div>
